...
#define HOMING_BUMP_MM { 5, 5, 2, 5, 5 } // { 5, 5, 2 }       // (mm) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 4, 2, 2 } // { 2, 2, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LCD_TIMEOUT_TO_STATUS 180000 // 15000
...
#define ARC_SUPPORT                 // Disable this feature to save ~3226 bytes
  ...
  #define MM_PER_ARC_SEGMENT .2 // 1 // (mm) Length (or minimum length) of each arc segment
  #define ARC_SEGMENTS_PER_R 1 // 1 // Max segment length, MM_PER = Min
 ...
 */
  ...
  #if AXIS_IS_L64XX(X)
    #define X_MICROSTEPS 32 // 128  // Number of microsteps (VALID: 1, 2, 4, 8, 16, 32, 128) - L6474 max is 16
